                    ...
                    <div class="ticket ticketFont">
                        ...
                        <table>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td class="linea"><input class="sinborde" maxlength="22" size="24" id="ticketIFE" placeholder="Numero de IFE" type="text"></td>
                                </tr>
                                <tr>
                                    <td id="ticketProducto" class="linea">Recibi del Sr. (s) :</td>
                                </tr>
                                <tr>
                                    <td class="linea"><textarea class="centrado sinborde" placeholder="Nombre de quien retira la unidad" id="ticketNombre" rows="2" cols="24"></textarea></td>
                                </tr>
                                <tr>
                                    <td class="linea">La cantidad de: </td>
                                </tr>
                                <tr>
                                    <td class="linea">$<input class="centrado sinborde" id="ticketImporte" placeholder="Importe" type="text"></td>
                                </tr>
                                <tr>
                                    <td class="linea"><textarea class="centrado sinborde" placeholder="Importe con letra" id="ticketImporteLetra" rows="2" cols="24"></textarea></td>
                                </tr>
                                <tr>
                                    <td class="linea">Por Concepto de:</td>
                                </tr>
                                <tr>
                                    <td class="linea"><textarea class="centrado sinborde" placeholder="Concepto de importe" id="ticketConcepto" rows="2" cols="24"></textarea></td>
                                </tr>
                                <tr>
