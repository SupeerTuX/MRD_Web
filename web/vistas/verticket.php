...
<head>
    ...
    <script type="text/javascript" src="../js/verticket.js"></script>
</head>
        ...
        <div class="ticket ticketFont">
            ...
            <table>
                ...
                <tbody>
                    ...
                    <tr>
                        <td class="linea"><textarea id="letraMenor" class="centrado sinborde" placeholder="Concepto de importe" rows="9" cols="36" disabled>Este RECIBO forma parte de la facturacion diaria deacuerdo a las leyes fiscales vigentes y solo podra solicitar factura dentro del mes corriente a la presentacion del servicio.
